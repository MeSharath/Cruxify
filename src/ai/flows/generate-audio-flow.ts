...
'use server';
/**
 * @fileOverview A flow for generating audio from text using Google's TTS model.
 *
 * - generateAudio - A function that takes text and returns the audio as a data URI.
...
export const GenerateAudioOutputSchema = z.object({
  audioData: z.string().describe("The generated audio as a base64-encoded data URI."),
});
